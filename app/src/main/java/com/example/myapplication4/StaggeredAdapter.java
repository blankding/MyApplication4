...
public class StaggeredAdapter extends ArrayAdapter<Fruit> {
    private int resource_id;
    public StaggeredAdapter(@NonNull Context context, int textViewResourceId, @NonNull List<Fruit> objects) {
